...
<h1 class="text-primary text-center">E-books || Admin</h1>

          <div class="d-flex justify-content-end">


<input type="text" class="form-control col-sm-2" id="searchbooks" name="searchbooks" oninput="searchBooks()" placeholder="Search Books" >
&nbsp; &nbsp;&nbsp;
<button type="button" class="btn btn-warning" data-toggle="modal" data-target="#ModalAddcv"> Add CSV
</button>
...
<input type="file" name="file" id="file">
      ...
      <div class="modal-footer">
        ...
        <input type="submit" name="submit"  class="btn btn-primary" value="Uploard CSV">
      </div>
    </div>
  </div>
</div>
